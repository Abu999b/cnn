...
# model = load_model('model/inception_v3_finetuned_L2.h5')
# conditions = [
...
MODEL_URL = 'https://huggingface.co/your_username/your_model_repo/resolve/main/inception_v3_finetuned_L2.h5'
